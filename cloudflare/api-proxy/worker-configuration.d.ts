/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config cloudflare/api-proxy/wrangler.jsonc cloudflare/api-proxy/worker-configuration.d.ts` (hash: 1295fb277b59b528a332c68837bd3af5)
// Runtime types generated with workerd@1.20260515.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	UPSTREAM_ORIGIN: "https://racing-ai-platform-api-production.up.railway.app";
	ALLOWED_ORIGINS: "https://ai-racing-telemetry-platform.vercel.app,https://ai-racing-telemetry-platform.marcosebastian1144.chatgpt.site";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPSTREAM_ORIGIN" | "ALLOWED_ORIGINS" | "ALLOWED_ORIGIN_HOST_PATTERNS" | "MAX_REQUEST_BYTES">> {}
}
