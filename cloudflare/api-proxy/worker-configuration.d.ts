/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config cloudflare/api-proxy/wrangler.jsonc cloudflare/api-proxy/worker-configuration.d.ts` (hash: a3ceed26e032236e6567097642162d52)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPSTREAM_ORIGIN" | "ALLOWED_ORIGINS" | "MAX_REQUEST_BYTES">> {}
}
