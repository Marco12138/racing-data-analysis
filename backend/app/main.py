...
from .api.track_reference_routes import router as track_reference_router
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    application.include_router(track_reference_router, prefix=active_settings.api_v1_prefix)
